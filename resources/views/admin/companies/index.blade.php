          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="border px-4 py-2">
                ...
                <a href="{{ route('admin.companies.approve', $profile->id) }}"
                  class="text-green-600 hover:text-green-900 mr-2">Approve</a>
                <a href="{{ route('admin.companies.reject', $profile->id) }}"
                  class="text-red-600 hover:text-red-900 mr-4">Reject</a>
                @endif
                <a href="{{ route('admin.companies.edit', $profile->id) }}"
                ...
                <x-modal name="confirm-userprofile-deletion"
                  focusable>
                  <form method="post"
                    action="{{ route('admin.companies.destroy', $profile->id) }}"
                    class="p-6">
                    @csrf
                    @method('delete')
                    ...
                    <div class="mt-6 flex justify-end">
                      ...
                      <a class="" href="{{Route("admin.companies")}}">Cancel</a>
