      ...
      <form
        ...
        <div class="mb-4">
          ...
          <input type="text" name="skills"
            value="{{implode(",", json_decode($talent_profile->skills))}}"
        ...
        <div id="experience-fields"
          ...
          @foreach (json_decode($talent_profile->experience) as $i => $exp)
        ...
        <div id="education-fields"
          ...
          @foreach (json_decode($talent_profile->education) as $i => $edu)
        ...
        <div id="portfolio-fields"
          ...
          @foreach (json_decode($talent_profile->portfolio) as $i => $port)
